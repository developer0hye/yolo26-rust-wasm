/* @ts-self-types="./yolo26_rust_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function detect(pixels, width, height, confidence_threshold) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArray8ToWasm0(pixels, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.detect(ptr0, len0, width, height, confidence_threshold);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./yolo26_rust_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('yolo26_rust_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
